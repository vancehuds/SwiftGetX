...
- Native `LibtorrentAdapter` isolated behind `canImport(CSwiftGetXLibtorrent)` and enabled with `SWIFTGETX_ENABLE_LIBTORRENT=1`, with lightweight fallback builds as the default.

...
struct AppResourcesTests {
    ...
    func chromeExtensionStoresDetailedNativeMessageErrors() throws {
        ...
        #expect(background.contains("String(details.method || \"\").toUpperCase() === \"HEAD\""))
        #expect(background.contains("context.bodyMetadata || String(context.method || \"\").toUpperCase() !== \"GET\""))
